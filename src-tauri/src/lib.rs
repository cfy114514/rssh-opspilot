    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            app.manage(AppState {
                ...
                codex_subscription: Arc::new(ai::codex_subscription::CodexSubscription::new(
                    data_dir.clone(),
                )),
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ai::commands::ai_codex_status,
            ai::commands::ai_codex_configure,
            ai::commands::ai_codex_login_start,
            ai::commands::ai_codex_login_cancel,
            ai::commands::ai_codex_logout,
